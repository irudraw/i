...
<div  role="main" class="ui-content" align="center">
  ...
  for(var i=0;i<foros.length;i++)
  {
  	...
  	document.write("<li>");
  		...
  		document.write("<a href='https://www.youtube.com/embed/"+pvideo+"??autoplay=1&wmode=transparent&rel=0&html5=1' class='html5lightbox' title='"+titulo+"' data-icon='star'>Video Previo</a>");
  		document.write("</a>");
  	document.write("</li>");
  }
  </script>
