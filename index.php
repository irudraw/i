...
<script>
  ...
  // Abrimos el archivo que esta alojado en el servidor cd_catalog.xml
  xmlhttp.open("GET","animenz/xml.php",false);
  xmlhttp.send();
  ...
  for(var i=0;i<foros.length;i++)
  {
  	...
  	document.write("<li>");
  		document.write("<a href='animenz/"+titulo+"/#0' target='_blank'>");
  		document.write("<img loading='lazy' src='animenz/"+titulo+"/poster.png' class='ui-li-thumb'  height='100%'>");
	  	//document.write("<img src='tumb.php?file=animenz/"+titulo+"/poster.png&w=250' class='ui-li-thumb'  height='100%'>");
  		//document.write("<h2>"+titulo+"</h2>");
	  	document.write("<p><b>"+titulo+"</b></p>");
  		//document.write("<p>Code: "+code+"</p>");
  		document.write("<p class='ui-li-aside'>ZAnime</p>");
...
-->
<h1><a href="//zanime.ml/">ZAnime.ml</a> <a href="//web.facebook.com/ZAnime-106439004441150">FB</a></h1>
