  ...
  <ul data-role="listview" data-inset="true" data-filter="true" data-input="#myFilter">
    ...
    <script>
      ...
      for(var i=0;i<foros.length;i++)
      {
  	  ...
  	  document.write("<li>");
  		document.write("<a href='https://zgrafic.com/code/mega/?v="+iurl+"&titulo="+titulo+"+"+cap+"' target='contenedor' onclick='window.location.href=");
      //document.write('"#"');
      document.write('"#');
      document.write(i);
      document.write('"');
...
s.src = 'https://zanime-1.disqus.com/embed.js';
...
<noscript>Please enable JavaScript to view the <a href="https://disqus.com/?ref_noscript">comments powered by Disqus.</a></noscript>
  ...
  <div data-role="collapsible" data-theme="b" data-content-theme="b">
    ...
    <iframe width="320px" height="205px" src="" frameborder="0" allowfullscreen name="contenedor" id="contenedor"></iframe><br>
...
<p>ZAnime © 2020 Todos los derechos reservados - Ningun video se encuentra alojado en nuestros servidores - Todo el contenido es tomado de internet.</p>
    ...
    function myFunction(xml) {
        ...
        document.getElementById("contenedor").src = 'https://zgrafic.com/code/mega/?v='+y.nodeValue+'&titulo='+n.nodeValue+' '+c.nodeValue;
